...
function Updatecard({ data, txt }) {
  return (
    <div className="dark:bg-dark2 bg-white w-full sm:w-[22%] h-auto rounded-sm flex flex-col justify-between p-2">
      <h1 className="text-gray-800 font-medium text-base dark:text-white">Site Performance</h1>
      <div className="flex flex-col sm:flex-row justify-between items-center mt-1 pr-2 pl-2">
        ...
        <div className="text-center mt-2 sm:mt-0 sm:text-right dark:text-white">
